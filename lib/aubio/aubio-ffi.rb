...
module Aubio::Api
  ...
  # (Not documented)
  # 
  # @method cvec_logmag(s, lambda)
  # @param [CvecT] s 
  # @param [Float] lambda 
  # @return [nil] 
  # @scope class
  attach_function :cvec_logmag, :cvec_logmag, [CvecT, :float], :void
  ...
  # (Not documented)
  # 
  # @method fvec_clamp(in_, absmax)
  # @param [FvecT] in_ 
  # @param [Float] absmax 
  # @return [nil] 
  # @scope class
  attach_function :fvec_clamp, :fvec_clamp, [FvecT, :float], :void
  ...
  # (Not documented)
  # 
  # @method aubio_pvoc_set_window(pv, window_type)
  # @param [AubioPvocT] pv 
  # @param [String] window_type 
  # @return [Integer] 
  # @scope class
  attach_function :aubio_pvoc_set_window, :aubio_pvoc_set_window, [AubioPvocT, :string], :uint
  ...
  # (Not documented)
  class AubioSpectralWhiteningT < FFI::Struct
    layout :dummy, :char
  end
  
  # (Not documented)
  # 
  # @method aubio_spectral_whitening_do(o, fftgrain)
  # @param [AubioSpectralWhiteningT] o 
  # @param [CvecT] fftgrain 
  # @return [nil] 
  # @scope class
  attach_function :aubio_spectral_whitening_do, :aubio_spectral_whitening_do, [AubioSpectralWhiteningT, CvecT], :void
  
  # (Not documented)
  # 
  # @method new_aubio_spectral_whitening(buf_size, hop_size, samplerate)
  # @param [Integer] buf_size 
  # @param [Integer] hop_size 
  # @param [Integer] samplerate 
  # @return [AubioSpectralWhiteningT] 
  # @scope class
  attach_function :new_aubio_spectral_whitening, :new_aubio_spectral_whitening, [:uint, :uint, :uint], AubioSpectralWhiteningT
  
  # (Not documented)
  # 
  # @method aubio_spectral_whitening_reset(o)
  # @param [AubioSpectralWhiteningT] o 
  # @return [nil] 
  # @scope class
  attach_function :aubio_spectral_whitening_reset, :aubio_spectral_whitening_reset, [AubioSpectralWhiteningT], :void
  
  # (Not documented)
  # 
  # @method aubio_spectral_whitening_set_relax_time(o, relax_time)
  # @param [AubioSpectralWhiteningT] o 
  # @param [Float] relax_time 
  # @return [Integer] 
  # @scope class
  attach_function :aubio_spectral_whitening_set_relax_time, :aubio_spectral_whitening_set_relax_time, [AubioSpectralWhiteningT, :float], :uint
  
  # (Not documented)
  # 
  # @method aubio_spectral_whitening_get_relax_time(o)
  # @param [AubioSpectralWhiteningT] o 
  # @return [Float] 
  # @scope class
  attach_function :aubio_spectral_whitening_get_relax_time, :aubio_spectral_whitening_get_relax_time, [AubioSpectralWhiteningT], :float
  
  # (Not documented)
  # 
  # @method aubio_spectral_whitening_set_floor(o, floor)
  # @param [AubioSpectralWhiteningT] o 
  # @param [Float] floor 
  # @return [Integer] 
  # @scope class
  attach_function :aubio_spectral_whitening_set_floor, :aubio_spectral_whitening_set_floor, [AubioSpectralWhiteningT, :float], :uint
  
  # (Not documented)
  # 
  # @method aubio_spectral_whitening_get_floor(o)
  # @param [AubioSpectralWhiteningT] o 
  # @return [Float] 
  # @scope class
  attach_function :aubio_spectral_whitening_get_floor, :aubio_spectral_whitening_get_floor, [AubioSpectralWhiteningT], :float
  
  # (Not documented)
  # 
  # @method del_aubio_spectral_whitening(o)
  # @param [AubioSpectralWhiteningT] o 
  # @return [nil] 
  # @scope class
  attach_function :del_aubio_spectral_whitening, :del_aubio_spectral_whitening, [AubioSpectralWhiteningT], :void
  ...
  # (Not documented)
  # 
  # @method aubio_onset_set_awhitening(o, enable)
  # @param [AubioOnsetT] o 
  # @param [Integer] enable 
  # @return [Integer] 
  # @scope class
  attach_function :aubio_onset_set_awhitening, :aubio_onset_set_awhitening, [AubioOnsetT, :uint], :uint
  
  # (Not documented)
  # 
  # @method aubio_onset_get_awhitening(o)
  # @param [AubioOnsetT] o 
  # @return [Float] 
  # @scope class
  attach_function :aubio_onset_get_awhitening, :aubio_onset_get_awhitening, [AubioOnsetT], :float
  
  # (Not documented)
  # 
  # @method aubio_onset_set_compression(o, lambda)
  # @param [AubioOnsetT] o 
  # @param [Float] lambda 
  # @return [Integer] 
  # @scope class
  attach_function :aubio_onset_set_compression, :aubio_onset_set_compression, [AubioOnsetT, :float], :uint
  
  # (Not documented)
  # 
  # @method aubio_onset_get_compression(o)
  # @param [AubioOnsetT] o 
  # @return [Float] 
  # @scope class
  attach_function :aubio_onset_get_compression, :aubio_onset_get_compression, [AubioOnsetT], :float
  ...
  # (Not documented)
  # 
  # @method aubio_onset_set_default_parameters(o, onset_mode)
  # @param [AubioOnsetT] o 
  # @param [String] onset_mode 
  # @return [Integer] 
  # @scope class
  attach_function :aubio_onset_set_default_parameters, :aubio_onset_set_default_parameters, [AubioOnsetT, :string], :uint
  
  # (Not documented)
  # 
  # @method aubio_onset_reset(o)
  # @param [AubioOnsetT] o 
  # @return [nil] 
  # @scope class
  attach_function :aubio_onset_reset, :aubio_onset_reset, [AubioOnsetT], :void
  ...
  # (Not documented)
  # 
  # @method fvec_push(in_, new_elem)
  # @param [FvecT] in_ 
  # @param [Float] new_elem 
  # @return [nil] 
  # @scope class
  attach_function :fvec_push, :fvec_push, [FvecT, :float], :void
  ...
  # (Not documented)
  # 
  # @method aubio_power_of_two_order(a)
  # @param [Integer] a 
  # @return [Integer] 
  # @scope class
  attach_function :aubio_power_of_two_order, :aubio_power_of_two_order, [:uint], :uint
  ...
  # (Not documented)
  class AubioPitchyinfastT < FFI::Struct
    layout :dummy, :char
  end
  
  # (Not documented)
  # 
  # @method new_aubio_pitchyinfast(buf_size)
  # @param [Integer] buf_size 
  # @return [AubioPitchyinfastT] 
  # @scope class
  attach_function :new_aubio_pitchyinfast, :new_aubio_pitchyinfast, [:uint], AubioPitchyinfastT
  
  # (Not documented)
  # 
  # @method del_aubio_pitchyinfast(o)
  # @param [AubioPitchyinfastT] o 
  # @return [nil] 
  # @scope class
  attach_function :del_aubio_pitchyinfast, :del_aubio_pitchyinfast, [AubioPitchyinfastT], :void
  
  # (Not documented)
  # 
  # @method aubio_pitchyinfast_do(o, samples_in, cands_out)
  # @param [AubioPitchyinfastT] o 
  # @param [FvecT] samples_in 
  # @param [FvecT] cands_out 
  # @return [nil] 
  # @scope class
  attach_function :aubio_pitchyinfast_do, :aubio_pitchyinfast_do, [AubioPitchyinfastT, FvecT, FvecT], :void
  
  # (Not documented)
  # 
  # @method aubio_pitchyinfast_set_tolerance(o, tol)
  # @param [AubioPitchyinfastT] o 
  # @param [Float] tol 
  # @return [Integer] 
  # @scope class
  attach_function :aubio_pitchyinfast_set_tolerance, :aubio_pitchyinfast_set_tolerance, [AubioPitchyinfastT, :float], :uint
  
  # (Not documented)
  # 
  # @method aubio_pitchyinfast_get_tolerance(o)
  # @param [AubioPitchyinfastT] o 
  # @return [Float] 
  # @scope class
  attach_function :aubio_pitchyinfast_get_tolerance, :aubio_pitchyinfast_get_tolerance, [AubioPitchyinfastT], :float
  
  # (Not documented)
  # 
  # @method aubio_pitchyinfast_get_confidence(o)
  # @param [AubioPitchyinfastT] o 
  # @return [Float] 
  # @scope class
  attach_function :aubio_pitchyinfast_get_confidence, :aubio_pitchyinfast_get_confidence, [AubioPitchyinfastT], :float
